...
# تابع هوشمند برای تولید برنامه تمرینی و غذایی
...
async def age_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("مرد", callback_data='مرد')],
        [InlineKeyboardButton("زن", callback_data='زن')],
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
    await query.edit_message_text("جنسیت شما چیست؟", reply_markup=reply_markup)
    return GENDER

# دریافت جنسیت و پرسیدن هدف
async def gender_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("چربی‌سوزی", callback_data='چربی‌سوزی')],
        [InlineKeyboardButton("حجم‌گیری", callback_data='حجم‌گیری')],
        [InlineKeyboardButton("قدرت", callback_data='قدرت')],
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
    await query.edit_message_text("هدف تمرینی شما چیست؟", reply_markup=reply_markup)
    return GOAL

# دریافت هدف و پرسیدن سطح
async def goal_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("مبتدی", callback_data='مبتدی')],
        [InlineKeyboardButton("متوسط", callback_data='متوسط')],
        [InlineKeyboardButton("حرفه‌ای", callback_data='حرفه‌ای')],
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
    await query.edit_message_text("سطح تمرینی شما چیست؟", reply_markup=reply_markup)
    return LEVEL

# دریافت سطح و پرسیدن تعداد روزها
async def level_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("۲ روز", callback_data='2')],
    ...
    reply_markup = InlineKeyboardMarkup(keyboard)
    await query.edit_message_text("چند روز در هفته تمرین می‌کنید؟", reply_markup=reply_markup)
    return DAYS

# دریافت روزها و پرسیدن محل تمرین
async def days_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("باشگاه", callback_data='باشگاه')],
        [InlineKeyboardButton("خانه", callback_data='خانه')],
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
    await query.edit_message_text("تمرین شما در باشگاه است یا خانه؟", reply_markup=reply_markup)
    return LOCATION

# پایان گفتگو و ارسال برنامه تمرینی و غذایی
